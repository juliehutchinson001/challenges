...
3) Write a function that looks at a string and scrambles
the letters between the first and last. This function
should take in a String as a parameter, and return a String.
The first letter and the last letter of the param String
should stay, the letters between the first and last will be
shuffled/randomized/scrambled.

// 2) Write a function that takes a string splits the words
into an array of strings and scrambles each word using the
function above. Then scramble the quote.

var words = "Every great dream begins with a dreamer.
